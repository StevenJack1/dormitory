    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li class="li">
                    <a href="#" url="/Visitor/" class="redirect"><i class="fa fa-user-plus" aria-hidden="true"></i><span class="nav-label">访客登记管理</span> </a>
                </li>
                <li class="li">
                <a href="#" url="/Student/" class="redirect"><i class="fa fa-users"></i> <span class="nav-label">学生管理</span> </a>
                </li>
            </ul>
        </div>
    </nav>
